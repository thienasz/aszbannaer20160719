    ...
    c.widget("ui.rotatable", c.ui.mouse, {
        ...
        performRotation: function (a) {
            if(this.options.workingEl){
                ...
                this.workingEl.css("transform-origin", this.options.rotationCenterX + "px " + this.options.rotationCenterY + "px");
                this.workingEl.css("-ms-transform-origin", this.options.rotationCenterX + "px " + this.options.rotationCenterY + "px");
                this.workingEl.css("-webkit-transform-origin", this.options.rotationCenterX + "px " + this.options.rotationCenterY + "px");
                this.workingEl.css("transform", "rotate(" + deg + "deg) translate3d(" + this.currentx + "px, " + this.currenty + "px, 0px)");
                this.workingEl.css("-moz-transform", "rotate(" + deg + "deg) translate3d(" + this.currentx + "px, " + this.currenty + "px, 0px)");
                this.workingEl.css("-webkit-transform",
                    "rotate(" + deg + "deg) translate3d(" + this.currentx + "px, " + this.currenty + "px, 0px)");
                this.workingEl.css("-o-transform", "rotate(" + deg + "deg) translate3d(" + this.currentx + "px, " + this.currenty + "px, 0px)");
            }

            this.element.css("transform-origin", this.options.rotationCenterX + "px " + this.options.rotationCenterY + "px");
            this.element.css("-ms-transform-origin", this.options.rotationCenterX + "px " + this.options.rotationCenterY + "px");
            this.element.css("-webkit-transform-origin", this.options.rotationCenterX + "px " + this.options.rotationCenterY + "px");
            this.element.css("transform", "rotate(" + deg + "deg) translate3d(" + this.currentx + "px, " + this.currenty + "px, 0px)");
            this.element.css("-moz-transform", "rotate(" + deg + "deg) translate3d(" + this.currentx + "px, " + this.currenty + "px, 0px)");
            this.element.css("-webkit-transform",
                "rotate(" + deg + "deg) translate3d(" + this.currentx + "px, " + this.currenty + "px, 0px)");
            this.element.css("-o-transform", "rotate(" + deg + "deg) translate3d(" + this.currentx + "px, " + this.currenty + "px, 0px)")
        },
        ...
        startRotate: function (a) {
            this.Y = this.workingEl.css("transform-origin").replace(/[^0-9\-., ]/g, '').split(' ')[0];
            this.X = this.workingEl.css("transform-origin").replace(/[^0-9\-., ]/g, '').split(' ')[1];

            var transformMatrix = this.workingEl.css("-webkit-transform") ||
                this.workingEl.css("-moz-transform")    ||
                this.workingEl.css("-ms-transform")     ||
                this.workingEl.css("-o-transform")      ||
                this.workingEl.css("transform");
            var matrix = transformMatrix.replace(/[^0-9\-., ]/g, '').split(',');
            console.log(parseFloat(this.X) + parseFloat(this.currentx));
            console.log(this.X);
            console.log(this.currentx);
            console.log(999);
            this.currentx = (matrix[12] || matrix[4]) ? matrix[12] || matrix[4] : 0;//translate x
            this.currenty = (matrix[13] || matrix[5]) ? matrix[13] || matrix[5] : 0;//translate y
            this.options.rotationCenterX = parseFloat(this.X) + parseFloat(this.currentx);
            this.options.rotationCenterY = parseFloat(this.Y) + parseFloat(this.currenty);
