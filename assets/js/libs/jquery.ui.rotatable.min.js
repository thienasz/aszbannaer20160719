    ...
    c.widget("ui.rotatable", c.ui.mouse, {
        ...
        performRotation: function (a) {
            if(this.options.workingEl){
                ...
                this.workingEl = $(name);
                this.workingEl.css("transform-origin", this.options.rotationCenterX + "% " + this.options.rotationCenterY + "%");
                this.workingEl.css("-ms-transform-origin", this.options.rotationCenterX + "% " + this.options.rotationCenterY + "%");
                this.workingEl.css("-webkit-transform-origin", this.options.rotationCenterX + "% " + this.options.rotationCenterY + "%");
                this.workingEl.css("transform", "rotate(" + a + "rad)");
                this.workingEl.css("-moz-transform", "rotate(" + a + "rad)");
                this.workingEl.css("-webkit-transform",
                    "rotate(" + a + "rad)");
                this.workingEl.css("-o-transform", "rotate(" + a + "rad)")
            }
        ...
        getElementCenter: function () {
            ...
            if (!1 === this.options.rotationCenterX)var b = a.left + this.element.width() / 2, a = a.top + this.element.height() / 2; else b = a.left + this.element.width() / 100 * this.options.rotationCenterX, a = a.top + this.element.height() / 100 * this.options.rotationCenterY;
            return [b, a]
        },
